...
import com.ril.pdf_box.fontbox.afm.FontMetrics;
import com.ril.pdf_box.fontbox.pfb.PfbParser;
...
class PDType1FontEmbedder
{
    ...
    static PDFontDescriptor buildFontDescriptor(Type1Font type1)
    {
        boolean isSymbolic = type1
            .getEncoding() instanceof com.ril.pdf_box.fontbox.encoding.BuiltInEncoding;
