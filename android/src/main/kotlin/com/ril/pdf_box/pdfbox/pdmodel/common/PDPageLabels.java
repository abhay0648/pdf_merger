...
public class PDPageLabels implements COSObjectable
{
     ...
     * {@link com.ril.pdf_box.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)}.
     * </p>
     * 
     * @param document
     *            The document the page label dictionary is created for.
     * @see com.ril.pdf_box.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)
     */
